...
if method == 1
	...
	print_significant_genes(dn_rows, probeset_signif_arr, 0, genes_orig, genes_new, mapObj, fid, db_obj, false);
	fprintf('Recording UP rows...\n');
	print_significant_genes(up_rows, probeset_signif_arr, 1, genes_orig, genes_new, mapObj, fid, db_obj, false);
	fclose(fid);
